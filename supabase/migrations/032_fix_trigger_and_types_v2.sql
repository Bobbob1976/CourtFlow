-- TRIGGER & TYPE FIX SCRIPT V2 (032)
-- Replaces TRY_CAST (which is not valid Postgres) with standard syntax.
...
-- Update booking_date safely (Just use CURRENT_DATE to avoid type errors during migration)
UPDATE bookings 
...
BEGIN
    ...
    -- FIXED: Explicitly cast to timestamptz using string concatenation
