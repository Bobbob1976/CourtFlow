-- NUCLEAR TRIGGER DISABLE SCRIPT (033)
-- The trigger is fighting back. We will disable ALL triggers, fix the data, and then re-enable.

-- 1. DISABLE ALL TRIGGERS (Silence the errors)
...
-- Update booking_date (safe update now that triggers are disabled)
...
-- Force start_time and end_time to TIME
...
-- 7. POPULATE TIME_RANGE (For existing data)
