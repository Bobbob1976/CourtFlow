-- FINAL NUCLEAR CLEANUP (036)
-- Strategy: Delete the problematic column and trigger entirely, then rebuild.
-- This guarantees no interference during the fix.

-- 1. DROP EVERYTHING DEPENDENT (Clean Slate)
...
-- 2. FIX BASE COLUMNS (Safe now that dependencies are gone)
DO $$
BEGIN
...
-- Fix Time Columns (Force to TIME type)
...
-- 6. RECREATE ATOMIC BOOKING FUNCTION
