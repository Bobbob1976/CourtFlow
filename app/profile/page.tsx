...
export default function ProfilePage() {
    ...
    // Mock Stats Data - Dit 'triggert het ego' zoals in de feedback
    const statsData = [
    ...
    return (
        <div className="min-h-screen bg-[#0A1628] text-white pb-20">
            ...
            {/* HEADER */}
            <div className="bg-[#132338] border-b border-white/5 pb-8 pt-12 px-4">
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
                    <div className="relative group cursor-pointer">
                        ...
                        <div className="absolute bottom-0 right-0 bg-[#C4FF0D] text-[#0A1628] text-xs font-bold px-3 py-1 rounded-full border border-[#0A1628]">ELITE</div>
                    </div>

                    <div className="text-center md:text-left">
                        <h1 className="text-3xl font-extrabold text-white mb-2">{profile?.full_name || user?.email?.split('@')[0]}</h1>
                        <p className="text-gray-400 mb-4">Padel Enthusiast • Amsterdam</p>
                        <div className="flex justify-center md:justify-start gap-3">
                            <button className="px-4 py-2 bg-white/10 rounded-lg font-bold text-sm hover:bg-white/20 transition-colors">Edit Profile</button>
                            <button className="px-4 py-2 text-gray-400 hover:text-white transition-colors">Settings</button>
                        </div>
                    </div>
            ...
            <div className="max-w-4xl mx-auto px-4 mt-12 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="bg-[#132338] rounded-3xl p-8 border border-white/5 relative overflow-hidden">
